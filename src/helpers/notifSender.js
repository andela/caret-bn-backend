...
const notifSender = async (subject, request, userId, notification, APP_URL_BACKEND) => {
  try {
      ...
      const msg = {
        ...
        html: `<div style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px;">
          ...
          <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
            Hello dear ${username},
            <br> This is to notify you that a request has been ${notification.activity} .
            <br> Click the button below to view the request.
          </p>
          <p><a style="background-color: #3097d1; border: 2px solid #3097d1; padding: 8px; color: #fff; font-size: 16px; text-decoration: none;cursor: pointer;" href="${APP_URL_BACKEND}/api/v1/requests/${request.id}">View request</a>
          </a></p>
