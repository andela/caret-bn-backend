    ...
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have
          .property("message")
          .eql(strings.users.error.NO_ACCESS);
        done();
      });
  });
  ...
  it("it should not book an accommodation with wrong id", done => {
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have
          .property("message")
          .eql("Ooops! This accommodation id does not exist!");
        done();
      });
  });
  ...
  it("it should not book an accommodation with no space", done => {
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have
          .property("message")
          .eql("There is no space available in accommodation");
        done();
      });
  });
  it("it should not book an accommodation twice", done => {
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have
          .property("message")
          .eql("you have already booked this accommodation");
        done();
      });
  });
  ...
  it("it should not book an accommodation checkOut greater than checkIn", done => {
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have
          .property("message")
          .eql("checkout date must not be less than checkin date");
        done();
      });
  });
  it("it should not book an accommodation with outdate dates", done => {
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have
          .property("message")
          .eql("CheckOut and CheckIn must not be outdate dates");
        done();
      });
  });
  ...
  it("it should not book an accommodation with unvailable rooms", done => {
    chai
      ...
      .end((err, res) => {
        ...
        res.body.should.have
          .property("message")
          .eql("roomsNumber exceed number of available rooms");
        done();
      });
  });
